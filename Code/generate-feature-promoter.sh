##input files 
	#tss-2k: the regions for coverage calculation of promoter NDRs; columns are transcript name, region, and gene direction: e.g. transcript1 chr7:127225399-127231399 +
