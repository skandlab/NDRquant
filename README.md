...
![Alt text](https://github.com/skandlab/NDRquant/blob/main/relative%20coverage.jpg?raw=true "Genomic regions over promoters (top) and first exon-intron junction (bottom) used to calculate relative coverage")
